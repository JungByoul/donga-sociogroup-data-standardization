...
이 v1.9가 1~3차판정 작업 개편의 최종 결과물. 이후 v2.1로 이름만 바꿔 1.41.44_품번_4차분리 폴더에
복사해서 진짜 4차판정 작업의 시작점으로 씀(내용은 v1.9와 동일).
"""
from pathlib import Path

import openpyxl

SRC = Path(r"C:\Users\정별\1_Work\1.41_동아쏘시오그룹(2)_데이터_표준화\1.41.43.5_품번_1~3차_작업_개편\20_결과\260810_S-TEPS_입고실적만 ◆_최근3개년_uniq_품번4차판정_v1.8.xlsx")
DST = Path(r"C:\Users\정별\1_Work\1.41_동아쏘시오그룹(2)_데이터_표준화\1.41.43.5_품번_1~3차_작업_개편\20_결과\260810_S-TEPS_입고실적만 ◆_최근3개년_uniq_품번4차판정_v1.9.xlsx")
